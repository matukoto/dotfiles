...
return {
  ...
  -- Load when denops is ready or specific events occur
  event = "VeryLazy",
  -- init = function()
  ...
  config = function()
    -- Defer configuration until ddc is fully loaded
    vim.schedule_wrap(function()
      ...
      vim.keymap.set('i', '<C-n>', "<Cmd>call pum#map#insert_relative(+1)<CR>", { noremap = true, silent = true, expr = false })
      vim.keymap.set('i', '<C-p>', "<Cmd>call pum#map#insert_relative(-1)<CR>", { noremap = true, silent = true, expr = false })
      vim.keymap.set('i', '<C-y>', "<Cmd>call pum#map#confirm()<CR>", { noremap = true, silent = true, expr = false })
      vim.keymap.set('i', '<C-e>', "<Cmd>call pum#map#cancel()<CR>", { noremap = true, silent = true, expr = false })
    ...
    end)() -- Immediately invoke the wrapped function
  end,
}
